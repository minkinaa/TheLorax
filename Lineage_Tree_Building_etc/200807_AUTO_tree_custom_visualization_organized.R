...
#output_dir = "/Users/anna/Documents/UW_GS/Shendure_Lab/Projects/Many_targets_ideas/CROPt/190722_Tree29_other7plates/TARG_plates2thru8/200623_NewPipelineAnalysis/201116_PostTreeBuild_AddAll_Cells/Consensus_Plot_New_Counts/"
#cut_df_file_name = "/Users/anna/Documents/UW_GS/Shendure_Lab/Projects/Many_targets_ideas/CROPt/190722_Tree29_other7plates/TARG_plates2thru8/200623_NewPipelineAnalysis/201116_PostTreeBuild_AddAll_Cells/Consensus_Plot_New_Counts/ReorderedCutDF_aka_cutdf"
#cigar_file_name = "/Users/anna/Documents/UW_GS/Shendure_Lab/Projects/Many_targets_ideas/CROPt/190722_Tree29_other7plates/TARG_plates2thru8/200623_NewPipelineAnalysis/201116_PostTreeBuild_AddAll_Cells/Consensus_Plot_New_Counts/Ordered_cigar_file.txt"
...
test_plot = test_plot + geom_rect(data =whole_set_df, mapping=aes(xmin = x2 + 1, xmax = x2+10, ymin=y2-.4, ymax=y2+.4, fill = factor(cigar_str)), color = "black")
...
test_plot = test_plot + xlim(0, max(whole_set_df$x2 + 90))

output_file_name = paste0(output_dir,"TreePlot_",suffix, "_cutInto", as.character(cut_df_col_to_use), ".pdf")
#pdf(output_file_name, width = 43, height = 200)
#pdf(output_file_name, width = 5, height = 5)
#pdf(output_file_name, width = 5, height = 200)

pdf(output_file_name, width =x_dim, height = y_dim)
