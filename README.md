...
RNA processing to generate cell by gene files implemented in wrapper script 190807_sciRNA_wrapper_ALL.txt. Internal code & input files have been uploaded to the folder "RNA_Processing"; some contain hard-coded file paths. Downstream processing and visualization code located in internal folders. 
